...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd([[bash -c 'f=/tmp/.qs_screenshot.png && grim -g "$(slurp)" "$f" && notify-send -a "qs-screenshot" "Screenshot" "$f"']]) )
