        ...
        Row {
            ...
            Item {
                ...
                Item {
                    ...
                    Item {
                        id: startIconRow
                        anchors { top: pfpHeader.bottom; left: parent.left; right: parent.right }
                        height: 108

                        Text {
                            anchors { left: parent.left; top: parent.top; topMargin: 10; leftMargin: 16 }
                        ...
                        ListView {
                            ...
                            anchors { left: parent.left; right: parent.right; bottom: parent.bottom; top: parent.top; topMargin: 36; leftMargin: 16; rightMargin: 16 }
                    ...
                    GridView {
                        anchors { top: startIconRow.bottom; bottom: parent.bottom; left: parent.left; right: parent.right; margins: 10 }
                        ...
                        delegate: Item {
                            ...
                            // drawn above pfpTile (and its photo) so the ring is never covered
                            Rectangle {
                                z: 10
